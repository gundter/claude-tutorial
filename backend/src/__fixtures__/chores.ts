import type { Chore, RecurrenceRule } from '../types/index.js';
...
export const mockChores = {
  ...
  recurring: createMockChore({
    id: 'chore-recurring-005',
    title: 'Weekly Standup',
    dueDate: '2026-01-20',
    recurrence: createMockRecurrence(),
  }),
  instance: createMockChore({
    id: 'chore-instance-006',
    title: 'Weekly Standup',
    dueDate: '2026-01-22',
    parentChoreId: 'chore-recurring-005',
